var _analytics = (function (exports) {
    ...
    function hn(n) {
        return (
            ...
            (q$1(n.message) &&
                n.constructor &&
                nn(n.constructor.stackTraceLimit))
        );
    }
        ...
        return (function (e) {
            for (
                ...
                "[]" === a.substring(a.length - 2)
                    ? (
                          t[(a = a.substring(0, a.length - 2))] || (t[a] = [])
                      ).push(i)
                    : (t[a] = "" === i || i);
            }
    ...
    function y$1() {
        for (
            var e = "", r = 0, t = (4294967295 * Math.random()) | 0;
            r++ < 36;
    ...
    var h$1 = "function",
        ...
        b$1 = /* #__PURE__ */ (function () {
            return (
                (typeof Symbol === h$1 && Symbol.observable) || "@@observable"
            );
        })(),
        I$1 = " != " + h$1;
                ...
                return Promise.resolve(
                            ...
                            return Promise.resolve(e).then(function (e) {
                                ...
                                var o = (function () {
                                    if (t.namespaced && t.namespaced[u])
                                        return Promise.resolve(
                                            t.namespaced[u].reduce(function (
                                                e,
                                                t,
                                                n
                                            ) {
                    ...
                    return Promise.resolve(
                        ...
                        if (
                            ...
                            if (
                                (s.plugins.includes(p),
                                e._ && e._.originalAction === p)
                            )
                                return e;
                            var n = g$1({}, e, {
                                _: {
    ...
    function ae(e) {
        return Object.keys(e).reduce(function (t, n) {
            return (
                "type" === n ||
                    (t[n] = on(e[n]) ? Object.assign({}, e[n]) : e[n]),
                t
            );
        }, {});
    }
                                        ...
                                        setTimeout(function () {
                                            return (function (e, t, n) {
                                                ...
                                                if (
                                                    ...
                                                    if (
                                                        f.processIndex &&
                                                        f.processIndex.length
                                                    ) {
                                                        f.processIndex.forEach(
                                                            function (t) {
                                                                var a =
                                                                        u
                                                                            .actions[
    ...
    var ce = function () {
        ...
        (this.before = []),
            ...
            (this.removeMiddleware = function (t, n) {
                ...
                -1 !== r &&
                    (e[n] = [].concat(e[n].slice(0, r), e[n].slice(r + 1)));
            }),
            ...
            n &&
                (B[o] =
                    ...
                    (a = (function (e) {
                        for (
                            var t,
                                n = e || Array.prototype.slice.call(arguments),
                                r = 0;
                            r < n.length;
                            r++
                        )
